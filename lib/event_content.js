...
define(function(require, exports, module) {
  ...
  EventContent.Effect = (function(_super) {
    ...
    Effect.prototype.parse = function() {
      var Effect, childrenLength, effectsLength, i;
      this.data.type = this.convertEventContentType(this.reader.readInt8());
      this.data.label = this.reader.readString();
      childrenLength = this.reader.readInt32() % 10000;
      this.data.children = (function() {
  ...
  EventContent.BranchByAlly = (function(_super) {

    __extends(BranchByAlly, _super);

    function BranchByAlly() {
      return BranchByAlly.__super__.constructor.apply(this, arguments);
    }

    BranchByAlly.prototype.parse = function() {
      BranchByAlly.__super__.parse.call(this);
  ...
  EventContent.PackageLink = (function(_super) {
    ...
    PackageLink.prototype.parse = function() {
      PackageLink.__super__.parse.call(this);
      this.data.id = this.reader.readInt32();
      return this.data;
    };
  ...
  EventContent.PackageCall = (function(_super) {
    ...
    PackageCall.prototype.parse = function() {
      PackageCall.__super__.parse.call(this);
      this.data.id = this.reader.readInt32();
      return this.data;
    };
