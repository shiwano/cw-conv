(function() {
  ...
  define(function(require, exports, module) {
    var BackgroundImage, Base, EventContent, EventContentBase, createEventContent, utils;
    utils = require('./utils');
    ...
    EventContentBase = (function(_super) {
      ...
      EventContentBase.prototype.parse = function() {
        ...
        length = this.reader.readInt32() % 10000;
    ...
    EventContent.StartLink = (function(_super) {
      ...
      StartLink.prototype.parse = function() {
        ...
        this.data.startLabel = this.reader.readString();
        return this.data;
      };
    ...
    EventContent.Battle = (function(_super) {
      ...
      Battle.prototype.parse = function() {
        ...
        this.data.ref = this.reader.readInt32();
        return this.data;
      };
    ...
    EventContent.Message = (function(_super) {
      ...
      Message.prototype.parse = function() {
        ...
        this.data.message = this.reader.readString();
        return this.data;
      };
    ...
    EventContent.BranchByFlag = (function(_super) {
      ...
      BranchByFlag.prototype.parse = function() {
        ...
        this.data.flagName = this.reader.readString();
        return this.data;
      };
    ...
    EventContent.Flag = (function(_super) {
      ...
      Flag.prototype.parse = function() {
        ...
        this.data.flagName = this.reader.readString();
        this.data.flag = this.reader.readBoolean();
        return this.data;
      };
    ...
    EventContent.BranchBySteps = (function(_super) {
      ...
      BranchBySteps.prototype.parse = function() {
        ...
        this.data.stepsName = this.reader.readString();
        return this.data;
      };
    ...
    EventContent.Steps = (function(_super) {
      ...
      Steps.prototype.parse = function() {
        ...
        this.data.stepsName = this.reader.readString();
        this.data.step = this.reader.readInt32();
        return this.data;
      };
    ...
    EventContent.BranchByFriend = (function(_super) {
    ...
    EventContent.Friend = (function(_super) {
    ...
    EventContent.Achievement = (function(_super) {
      ...
      Achievement.prototype.parse = function() {
        ...
        this.data.achievement = this.reader.readString();
        this.data.achievementScore = this.reader.readInt32();
        this.data.targetScope = this.convertTargetScopeType(this.reader.readInt8());
        return this.data;
      };
    ...
    EventContent.FriendLoss = (function(_super) {
    ...
    EventContent.CharacterMessage = (function(_super) {
      ...
      CharacterMessage.prototype.readMessage = function() {
        var achievements;
        achievements = this.reader.readString();
        return {
    ...
    EventContent.BranchByLevel = (function(_super) {
      ...
      BranchByLevel.prototype.parse = function() {
        ...
        this.data.useAverage = this.reader.readBoolean();
        this.data.level = this.reader.readInt32();
        return this.data;
      };
    ...
    EventContent.BranchByCharacterState = (function(_super) {
      ...
      BranchByCharacterState.prototype.parse = function() {
        ...
        this.data.characterState = this.convertCharacterStateType(this.reader.readInt8());
        this.data.target = this.convertTargetType(this.reader.readInt8());
        return this.data;
      };
    ...
    EventContent.PackageLink = (function(_super) {
    ...
    EventContent.PackageCall = (function(_super) {
    ...
    EventContent.BranchByCompletedStamp = (function(_super) {
      ...
      BranchByCompletedStamp.prototype.parse = function() {
        ...
        this.data.completedStamp = this.reader.readString();
        return this.data;
      };
